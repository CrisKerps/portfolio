...
public class WebAuthorization extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/web/index.html", "/web/index.php","/web/script/login.js","/web/login.html","/web/styles/**", "/web/assets/**", "/web/script/index.js","/web/images/**", "/web/img/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/clients").permitAll()
                .antMatchers("/api/payment").permitAll()
                .antMatchers("/rest/**").hasAuthority("ADMIN")
                .antMatchers("/api/admin/**").hasAuthority("ADMIN")
                .antMatchers("/manager.html", "/web/script/manager.js", "/admin.html", "/admin.js","/assets/logo-removebg-preview.png","/manager.js").hasAuthority("ADMIN")
